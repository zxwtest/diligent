...
import xyx.njtech.edu.cn.diligentnode.bean.Group;
import xyx.njtech.edu.cn.diligentnode.bean.Note;
import xyx.njtech.edu.cn.diligentnode.db.GroupDao;
import xyx.njtech.edu.cn.diligentnode.db.NoteDao;
import xyx.njtech.edu.cn.diligentnode.utils.CommonUtil;
import xyx.njtech.edu.cn.diligentnode.utils.ImageUtils;
import xyx.njtech.edu.cn.diligentnode.utils.SDCardUtil;
import xyx.njtech.edu.cn.diligentnode.utils.StringUtils;
import xyx.njtech.edu.cn.diligentnode.xrichtext.RichTextEditor;
        ...
        switch (item.getItemId()){
            case R.id.action_insert_image:
                if (ContextCompat.checkSelfPermission(NewActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED
                        || ContextCompat.checkSelfPermission(NewActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(NewActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_EXTERNAL_STORAGE}, 1);
                }else {
                    callGallery();
                }
                break;
