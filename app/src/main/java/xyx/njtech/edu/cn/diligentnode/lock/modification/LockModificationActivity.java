...
import xyx.njtech.edu.cn.diligentnode.contants.CacheManager;
...
public class LockModificationActivity extends MemoBaseActivity<ILockModificationView, LockModificationPresenter>
    ...
    protected int attachLayoutRes() {
        System.out.println("==========attachLayoutRes========="+mContext.getApplicationContext());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        System.out.println("=======enter onOptionsItemSelected===========");
